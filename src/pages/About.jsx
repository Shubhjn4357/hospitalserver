   ...
   <div className="container">
      <div className="row">
         <div className="col-md-12 pb-20 text-center"> 
            <h2 className="section-title mb-10"><span> I am  <strong className="primary-color">Shubham Jain</strong> Web Developer</span></h2>
      ...
      <div className="row">
         ...
         <div className="col-md-4">
            <ul className="i-list medium">
               <li className="i-list-item">
                  <div className="icon"> <i className="fa fa-codepen"></i> </div>
                  <div className="icon-content">
